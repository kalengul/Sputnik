...
Procedure AddStation(NewStation:PStation);
  ...
  If Station=nil then
    begin
    Station:=NewStation;    //—озданна€ вершина - перва€
    LastStation:=NewStation;
    end
  else
    begin
    LastStation.Next:=NewStation;  //ƒобавление созданной вершины в конец списка вершин
    LastStation:=NewStation;
    end;
  end;
...
Procedure AddSattelite(NewSattelite:PSattelite);
  ...
  If Sattelite=nil then
    begin
    Sattelite:=NewSattelite;    //—озданна€ вершина - перва€
    LastSattelite:=NewSattelite;
    end
  else
    begin
    LastSattelite.Next:=NewSattelite;  //ƒобавление созданной вершины в конец списка вершин
    LastSattelite:=NewSattelite;
    end;
  end;
...
Procedure AddTraektory(Sattelite:Psattelite; NewTraektory:PTraektory);
  ...
  If Sattelite.Traektory=nil then
    begin
    Sattelite.Traektory:=NewTraektory;    //—озданна€ вершина - перва€
    Sattelite.LastTraektory:=NewTraektory;
    end
  else
    begin
    Sattelite.LastTraektory.Next:=NewTraektory;  //ƒобавление созданной вершины в конец списка вершин
    Sattelite.LastTraektory:=NewTraektory;
    end;
  end;
...
Procedure AddSobitie(NewSobitie:PSobitie);
  ...
  If Sobitie=nil then
    begin
    Sobitie:=NewSobitie;    //—озданна€ вершина - перва€
    LastSobitie:=NewSobitie;
    end
  else
    begin
    LastSobitie.Next:=NewSobitie;  //ƒобавление созданной вершины в конец списка вершин
    LastSobitie:=NewSobitie;
    end;
  end;
